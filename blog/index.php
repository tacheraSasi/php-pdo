...
<body class="bg-neutral-100 font-sans">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex items-center justify-between px-6 py-4">
            ...
            <nav class="hidden md:flex space-x-6">
                <a href="#latest" class="text-sm font-medium text-neutral-700 hover:text-orange-600">Latest Posts</a>
                <a href="#about" class="text-sm font-medium text-neutral-700 hover:text-orange-600">About</a>
                <a href="#contact" class="text-sm font-medium text-neutral-700 hover:text-orange-600">Contact</a>
            </nav>
            <button class="md:hidden bg-neutral-900 text-white px-3 py-2 rounded focus:ring focus:ring-orange-300">
                Menu
            </button>
        </div>
    </header>
    ...
    <section class="relative bg-neutral-900 text-white">
        <div class="container mx-auto text-center px-6 py-20">
            ...
            <a href="#latest"
                class="inline-block mt-6 px-6 py-3 bg-orange-400 text-white font-semibold rounded-md hover:bg-orange-500 focus:ring focus:ring-orange-300">
                Explore Posts
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <a href="#" class="mt-4 inline-block text-orange-600 text-sm font-medium hover:underline">Read
                            More</a>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <form action="#" method="POST" class="mt-8 max-w-xl mx-auto space-y-4">
                <input type="text" name="name" placeholder="Your Name" required
                    class="w-full px-4 py-3 border rounded-md text-neutral-900 placeholder-neutral-400 focus:ring-orange-500 focus:border-orange-500">
                <input type="email" name="email" placeholder="Your Email" required
                    class="w-full px-4 py-3 border rounded-md text-neutral-900 placeholder-neutral-400 focus:ring-orange-500 focus:border-orange-500">
                <textarea name="message" rows="4" placeholder="Your Message" required
                    class="w-full px-4 py-3 border rounded-md text-neutral-900 placeholder-neutral-400 focus:ring-orange-500 focus:border-orange-500"></textarea>
                <button type="submit"
                    class="w-full py-2 px-4 bg-neutral-900 text-white font-semibold rounded-md shadow hover:bg-orange-500 focus:ring focus:ring-orange-300">
                    Send Message
                </button>
            </form>
        </div>
